# -*- coding: utf-8 -*-
"""LaCopia de A01571442_ProyectoStreamlitencolab2 (1).ipynb
...
#GRAFICA2
with tab2:
    st.subheader("🌍 Análisis por Nacionalidad y Métrica Ponderada")
...
#GRAFICA4
with tab4:
    st.subheader("💼 Análisis de Segmentos (Club o Nacionalidad)")
